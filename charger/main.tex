...
\solution \lstinputlisting{./codes/1_1.py}
This code plots $x(t)$ in Fig. \eqref{fig:xt}.
\begin{figure}[!ht]
...
\solution \lstinputlisting{./codes/2_3.py}
This code verifies \eqref{eq:one-Z-real}.
\begin{figure}[!ht]
...
\solution \lstinputlisting{./codes/2_6.py}
This code verifies \eqref{eq:one-Z-real}.
\begin{figure}[!ht]
