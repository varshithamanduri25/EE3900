...
\author{Sri Varshitha Manduri\\BM20BTECH11014}
...
\begin{figure}[!h]
    ...
    \label{fig:ckt-q1}
\end{figure}
The equivalent circuit at steady-state when the switch is at P is shown above.
...
\solution \lstinputlisting{./codes/2_7.cir} This code simulates the given circuit and the generated output is depicted in Fig. \eqref{fig:v1-t}
\end{enumerate}
...
\solution\lstinputlisting{./codes/3_5.cir} This code in ngspice simulates the given circuit and the generated output is depicted in Fig. \eqref{fig:v2-t}.
